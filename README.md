...
The framework of our M-TBNE includes TBNE [TBNE](https://github.com/maryqizhiwei/M-TBNE/blob/main/TBNE.png) and TBNE based multiple probabilistic inferences.
